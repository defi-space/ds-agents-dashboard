 ...
 * Dashboard Starter
 * 
 * This script starts both the frontend and backend servers for the ds-agents-dashboard.
 * 
 * Usage:
...
// Start the dashboard
console.log('\n' + colors.bright + colors.fg.green + '✓ ds-agents-dashboard is starting up!' + colors.reset);
